    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-pencil"></i> Evaluation Professor to Professor Rankings</h3>
...
$student = $dbcon->query("SELECT AVG(r_result) as total, fname, mname, lname FROM evaluation_user 
  ...
  WHERE user_role = '1' GROUP BY evaluation_code ORDER BY total DESC") or die(mysqli_error());
