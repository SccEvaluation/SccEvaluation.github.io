    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-calendar-o"></i> Professor Result</h3>
...
$student = $dbcon->query("SELECT * FROM evaluation_user
  ...
  WHERE YEAR(date_created) = '".$_POST['year']."' AND user_role = '1'") or die(mysqli_error());
while($row = $student->fetch_assoc()):
?>

            <tr>
                <td><a href="prof_rate.php?evaluation_code=<?php echo $row['evaluation_code']?>"><?php echo $row['evaluation_code']?></a></td>
