    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-pencil"></i> Evaluation Rankings</h3>
...
<?php 
$count = '1';
$student = $dbcon->query("SELECT AVG(r_result) as total, fname, mname, lname
  FROM evaluation_sheet INNER JOIN result on result.e_code = evaluation_sheet.e_code
  ...
  GROUP BY sub_incharge ORDER BY total DESC") or die(mysqli_error());
