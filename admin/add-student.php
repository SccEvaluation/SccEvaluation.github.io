        ...
        <form method="post">
            ...
            <div class="row">
              <div class="col-md-7">
                ...
                <br>
                  <input type="text" class="form-control" name="lname" placeholder="Last Name" required value="<?php if(isset($_GET['user_id'])): echo $lname; elseif(isset($_POST['save_button'])): echo $_POST['lname']; endif;?>" <?php if(isset($_GET['user_id'])): echo 'readonly';endif;?>> 
                  <p></p>
                  <input type="text"  class="form-control" name="suffix" placeholder="Jr. Sr. 3rd" value="<?php if(isset($_GET['user_id'])): echo $suffix; elseif(isset($_POST['save_button'])): echo $_POST['suffix']; endif;?>"> 
              </div>
             ...
             <div class="row">
              ...
              <div class="col-md-7">
                ...
                <br>
                  <input type="text" name="user_address" placeholder="Address" required value="<?php if(isset($_GET['user_id'])): echo $user_address; elseif(isset($_POST['save_button'])): echo $_POST['user_address']; endif;?>" class="form-control"><p></p>

                  <input type="text" class="form-control" name="user_brgy" placeholder="Barangay" required value="<?php if(isset($_GET['user_id'])): echo $user_brgy; elseif(isset($_POST['save_button'])): echo $_POST['user_brgy']; endif;?>"> 
                  <p></p>
                  <input type="text" class="form-control" name="user_city" placeholder="City" value="<?php if(isset($_GET['user_id'])): echo $user_city; elseif(isset($_POST['save_button'])): echo $_POST['user_city']; endif;?>"> 
              </div>
            </div>
            <div class="row">
              <div class="col-md-7">
