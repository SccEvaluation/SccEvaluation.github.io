...
$student = getdata_where("*","user_role","user_account","2");
...
<?php include'../assets/admin_sidebar.php';?>
    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid" style="padding:15px;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-users"></i> Student - <a href="add-student.php" class="btn btn-info"><i class="fa fa-plus"></i> Add Information</a> 
 ...
 <?php echo $value->lname?> <?php echo $value->suffix?>                    </td>
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="add-student.php?user_id=<?php echo $value->user_id?>"><i class="fa fa-pencil"></i> Update</a></li>
                    <li>
                      <a href="#" <?php echo 'onclick=" confirm(\'Are you sure you want to Delete?\') 
      ?window.location = \'student.php?delete='.$value->user_id.'\' : \'\';"'; ?>><i class="fa fa-remove"></i> Delete</a>
    </li>
    <li>
                      <a href="#" <?php echo 'onclick=" confirm(\'Are you sure you want to reset?\') 
      ?window.location = \'student.php?reset='.$value->user_name.'\' : \'\';"'; ?>><i class="fa fa-file"></i> Reset</a>
    </li>
                  </ul>
                  </div>
                  </td>
