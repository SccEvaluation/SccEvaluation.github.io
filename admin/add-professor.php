...
switch (true) {
  case isset($_POST['save_button']):
    ...
    elseif(!is_numeric($idno)){
      $msg = 'We only accept numbers only.';
    }*/
    else{
    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid" style="padding:15px;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-plus"></i> Professor Information </h3>
              <hr>
        <?php if(isset($msg)):?><div class="alert alert-danger"><?php echo $msg; ?></div><?php endif;?>
            ...
            <p></p>
             ...
             <div class="row">
              <div class="col-md-7">
                <strong>Account Option</strong>
                  <select class="form-control" name="user_role">
                 
                    <option value="1" <?php if(isset($_GET['user_id'])){
                      if($user_role== "1"){
                        echo 'selected';
                      }
                        }
                ...
                ?>>Professor</option>
                    <option value="3" <?php if(isset($_GET['user_id'])){
                      if($user_role== "3"){
                        echo 'selected';
                      }
                        }
             ...
             <center>
                ...
                <a href="professor.php" class="btn btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>
