...
$query = "SELECT * FROM questions WHERE question_cat = 'chairman' ORDER BY q_id ASC";
    ...
    <section style="padding:11px;">
      ...
      <div class="box box-solid" style="padding:15px;">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-book"></i> Chairman to Chairman Questions - <a href="question_chairman.php" class="btn btn-info">Add Data</a></h3>
              <hr>
